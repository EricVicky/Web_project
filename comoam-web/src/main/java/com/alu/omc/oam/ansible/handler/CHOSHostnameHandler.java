...
@Component("CHHOSTNAME_OPENSTACK_HANDLER")
@Scope(value = "prototype")
public class CHOSHostnameHandler extends DefaultHandler 
{
    private static Logger log = LoggerFactory.getLogger(CHOSHostnameHandler.class);
    @Override
    public void onStart()
    {
    	super.onStart();
    ...
    public void onSucceed()
    {
       ...
       ((CHOSHostnameConfig)config).setOld_vm_config(null);
