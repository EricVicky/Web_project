...
public class CHOSHostnameConfig extends COMConfig implements NetworkConfig, Serializable
{
	...
	private static Logger log = LoggerFactory.getLogger(CHOSHostnameConfig.class);	
