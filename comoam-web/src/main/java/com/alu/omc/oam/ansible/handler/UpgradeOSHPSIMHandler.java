...
@Component("UPGRADE_OPENSTACK_HPSIM_HANDLER")
@Scope(value = "prototype")
public class UpgradeOSHPSIMHandler implements IAnsibleHandler {
   ...
   // private Pattern stackPattern = Pattern.compile("^.*TASK:\\s\\[deploy\\_stack\\s\\|\\scheck\\spresence\\sof\\sheat\\sstack\\].*$");
    private static Logger logger = LoggerFactory.getLogger(UpgradeOSHPSIMHandler.class);
	@Override
	public void onStart() {
